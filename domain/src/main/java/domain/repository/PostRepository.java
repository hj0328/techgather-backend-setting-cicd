...
public interface PostRepository extends JpaRepository<Post, Long> {
	...
	@Query("SELECT p FROM Post p " +
		   ...
		   "ORDER BY p.postId DESC")
	List<Post> findAllPost(@Param("lastPostId") Long lastPostId,
	...
	@Query("SELECT p FROM Post p " +
		   ...
		   "ORDER BY p.postId DESC")
	List<Post> findPostByTag(@Param("tagName") String tagName,
							 @Param("limit") Long limit);
	...
	@Query("SELECT p FROM Post p " +
		   ...
		   "ORDER BY p.postId DESC")
	List<Post> findPostByAutoCompleteSuggestions(@Param("postName") String postName,
												 @Param("limit") Long limit);
